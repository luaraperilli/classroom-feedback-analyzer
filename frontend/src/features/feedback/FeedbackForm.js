      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-6 sm:p-7 relative overflow-hidden shadow-[0_20px_24px_-4px_rgba(16,24,40,0.14),0_8px_8px_-4px_rgba(16,24,40,0.04)] mb-6">
          ...
          <div className="relative z-10">
            ...
            {/* Diz o que vai voltar, antes de a pessoa preencher.
                São três devolutivas separadas, e não três parcelas de uma média:
                a média sai só das seis respostas, a leitura sai só do comentário,
                e as cores explicam a leitura. Descrevê-las como pilares de uma
                nota só criaria a contradição que a devolutiva existe para
                desfazer, quando a média e a leitura discordam. */}
            <div className="mt-3 flex items-start gap-2.5 rounded-xl bg-white/15 px-4 py-3">
              <svg className="w-5 h-5 text-white flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z" />
              </svg>
              <p className="text-white text-sm leading-relaxed">
                <strong className="font-semibold">Você recebe três coisas de volta.</strong> A média das suas
                seis respostas, uma leitura do que você escreveu, e o destaque das palavras que mais pesaram
                nessa leitura. As duas primeiras vêm de lugares diferentes e podem discordar — quando isso
                acontece, o sistema diz.
              </p>
            </div>
          </div>
        </div>
